...
export const FloralCorner = ({ className = '', mirror = false, size = 180 }) => (
  ...
  >
    ...
    <g transform="translate(55, 100)">
      <ellipse cx="0" cy="-3" rx="3" ry="5" fill="rgba(98,159,173,0.4)" />
      <ellipse cx="-3" cy="0" rx="3" ry="5" fill="rgba(12,44,85,0.35)" transform="rotate(-40)" />
      <ellipse cx="3" cy="0" rx="3" ry="5" fill="rgba(12,44,85,0.35)" transform="rotate(40)" />
    </g>
    {/* Flower 3 */}
    ...
    {/* Small dots / berries */}
    <circle cx="60" cy="80" r="2" fill="rgba(98,159,173,0.3)" />
    <circle cx="45" cy="120" r="1.5" fill="rgba(12,44,85,0.4)" />
    <circle cx="165" cy="15" r="1.5" fill="rgba(98,159,173,0.3)" />
    <circle cx="130" cy="20" r="2" fill="rgba(12,44,85,0.35)" />
  </svg>
);
...
export const FloralDivider = ({ className = '' }) => (
  ...
  >
    ...
    <g transform="translate(200, 30)">
      <circle cx="0" cy="0" r="8" fill="rgba(98,159,173,0.5)" />
      <ellipse cx="-7" cy="-3" rx="5" ry="8" fill="rgba(98,159,173,0.3)" transform="rotate(-30)" />
      <ellipse cx="7" cy="-3" rx="5" ry="8" fill="rgba(98,159,173,0.3)" transform="rotate(30)" />
      <ellipse cx="-5" cy="5" rx="4" ry="7" fill="rgba(12,44,85,0.35)" transform="rotate(-60)" />
      <ellipse cx="5" cy="5" rx="4" ry="7" fill="rgba(12,44,85,0.35)" transform="rotate(60)" />
      <ellipse cx="0" cy="-7" rx="4" ry="6" fill="rgba(98,159,173,0.25)" />
      <circle cx="0" cy="0" r="3" fill="rgba(98,159,173,0.6)" />
    </g>
    {/* Left vine */}
    <path d="M200 30 C180 28, 150 26, 120 28 C90 30, 60 34, 30 30" stroke="rgba(41,99,116,0.4)" strokeWidth="1.5" fill="none" />
    <path d="M200 30 C175 32, 145 30, 115 32 C85 34, 55 30, 25 32" stroke="rgba(98,159,173,0.25)" strokeWidth="1" fill="none" />
    {/* Right vine */}
    ...
    {/* Left leaves */}
    <ellipse cx="80" cy="28" rx="3" ry="7" fill="rgba(41,99,116,0.3)" transform="rotate(-30, 80, 28)" />
    <ellipse cx="90" cy="32" rx="2.5" ry="6" fill="rgba(41,99,116,0.25)" transform="rotate(20, 90, 32)" />
    <ellipse cx="140" cy="27" rx="3" ry="7" fill="rgba(41,99,116,0.25)" transform="rotate(-20, 140, 27)" />
    {/* Left small flower */}
    <g transform="translate(55, 31)">
      <ellipse cx="0" cy="-2" rx="2.5" ry="4" fill="rgba(98,159,173,0.35)" />
      <ellipse cx="-2.5" cy="1" rx="2.5" ry="4" fill="rgba(12,44,85,0.3)" transform="rotate(-45)" />
      <ellipse cx="2.5" cy="1" rx="2.5" ry="4" fill="rgba(12,44,85,0.3)" transform="rotate(45)" />
    </g>
    {/* Right leaves */}
    <ellipse cx="320" cy="28" rx="3" ry="7" fill="rgba(41,99,116,0.3)" transform="rotate(30, 320, 28)" />
    <ellipse cx="310" cy="32" rx="2.5" ry="6" fill="rgba(41,99,116,0.25)" transform="rotate(-20, 310, 32)" />
    <ellipse cx="260" cy="27" rx="3" ry="7" fill="rgba(41,99,116,0.25)" transform="rotate(20, 260, 27)" />
    {/* Right small flower */}
    ...
    {/* Dots */}
    <circle cx="110" cy="29" r="1.5" fill="rgba(98,159,173,0.3)" />
    <circle cx="170" cy="28" r="1.5" fill="rgba(12,44,85,0.35)" />
    <circle cx="230" cy="28" r="1.5" fill="rgba(12,44,85,0.35)" />
    <circle cx="290" cy="29" r="1.5" fill="rgba(98,159,173,0.3)" />
  </svg>
);
...
export const BismillahDecor = ({ className = '' }) => (
  ...
  >
    <span className="text-3xl md:text-4xl text-dark font-calligraphy leading-relaxed">
...
export const RingIcon = ({ className = '' }) => (
  <svg viewBox="0 0 80 40" fill="none" className={`w-20 h-auto ${className}`}>
    <circle cx="28" cy="20" r="12" stroke="rgba(98,159,173,0.5)" strokeWidth="2" fill="none" />
    <circle cx="52" cy="20" r="12" stroke="rgba(12,44,85,0.6)" strokeWidth="2" fill="none" />
    {/* Diamond */}
    <g transform="translate(28, 8)">
      <path d="M0 0 L2 -4 L4 0 L2 3 Z" fill="rgba(41,99,116,0.6)" />
    </g>
  </svg>
);
...
export const WatercolorBlob = ({ className = '', color = 'primary', size = 300 }) => {
  const colors = {
    primary: 'rgba(98,159,173,0.08)',
    secondary: 'rgba(41,99,116,0.08)',
    accent: 'rgba(12,44,85,0.1)',
  };
  return (
    <div
